...
import { OMNIDEF } from './tetetTetetEnglish_def.js';
import tmpl from './tetetTetetEnglish.html';
import tmpl_nds from './tetetTetetEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class tetetTetetEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
