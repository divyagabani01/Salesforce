...
import { OMNIDEF } from './dCreateAccountWithLWCDCreateAccountWithLWCEnglish_def.js';
import tmpl from './dCreateAccountWithLWCDCreateAccountWithLWCEnglish.html';
import tmpl_nds from './dCreateAccountWithLWCDCreateAccountWithLWCEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class dCreateAccountWithLWCDCreateAccountWithLWCEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
