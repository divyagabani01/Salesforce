...
import { OMNIDEF } from './nAccConDetailsNAccConDetailsEnglish_def.js';
import tmpl from './nAccConDetailsNAccConDetailsEnglish.html';
import tmpl_nds from './nAccConDetailsNAccConDetailsEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class nAccConDetailsNAccConDetailsEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
