...
import { OMNIDEF } from './nextAndPreFunctinalityNextAndPreFunctinalityEnglish_def.js';
import tmpl from './nextAndPreFunctinalityNextAndPreFunctinalityEnglish.html';
import tmpl_nds from './nextAndPreFunctinalityNextAndPreFunctinalityEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class nextAndPreFunctinalityNextAndPreFunctinalityEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
