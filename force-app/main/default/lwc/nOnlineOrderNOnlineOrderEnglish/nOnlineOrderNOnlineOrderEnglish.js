...
import { OMNIDEF } from './nOnlineOrderNOnlineOrderEnglish_def.js';
import tmpl from './nOnlineOrderNOnlineOrderEnglish.html';
import tmpl_nds from './nOnlineOrderNOnlineOrderEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class nOnlineOrderNOnlineOrderEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
