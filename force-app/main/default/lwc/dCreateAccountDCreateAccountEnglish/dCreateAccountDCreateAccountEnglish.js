...
import { OMNIDEF } from './dCreateAccountDCreateAccountEnglish_def.js';
import tmpl from './dCreateAccountDCreateAccountEnglish.html';
import tmpl_nds from './dCreateAccountDCreateAccountEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class dCreateAccountDCreateAccountEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
